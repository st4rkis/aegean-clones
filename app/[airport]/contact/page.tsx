...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Athens International Airport (ATH) Contact & Location"
  const title = `${city} ${type} Airport (${code}) Contact & Location`;

  // Description: "Contact Athens Airport customer service, lost and found, and police. View interactive map, driving directions, and address for Athens International Airport."
  const description = `Contact ${city} Airport customer service, lost and found, and police. View interactive map, driving directions, and address for ${city} ${type} Airport.`;
