...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Athens International Airport (ATH) - Passenger Services & Info"
  const title = `${city} ${type} Airport (${code}) - Passenger Services & Info`;

  // Description: "Find terminals, lost and found, WiFi, and special assistance at Athens Airport. Your complete guide to airport facilities."
  const description = `Find terminals, lost and found, WiFi, and special assistance at ${city} ${type} Airport. Your complete guide to airport facilities.`;
