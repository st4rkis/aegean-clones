...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Privacy Policy - Athens International Airport (ATH) Guide"
  const title = `Privacy Policy - ${city} ${type} Airport (${code}) Guide`;

  // Description: "Read our Privacy Policy to understand how we collect, use, and protect your data at Athens Airport. GDPR compliance, cookies, and your rights explained."
  const description = `Privacy Policy for ${city} ${type} Airport (${code}). How we collect and protect your data, including GDPR compliance, cookies, and your rights.`;
