...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Athens International Airport (ATH) - Bus Routes & Schedules"
  const title = `${city} ${type} Airport (${code}) - Bus Routes & Schedules`;

  // Description: "Find public bus routes, schedules, and ticket info for Athens Airport. Cheap transfers to the city center and port."
  const description = `Find public bus routes, schedules, and ticket info for ${city} ${type} Airport. Cheap transfers to the city center and port.`;
