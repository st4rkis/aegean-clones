...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Athens International Airport (ATH) - Parking & Drop-off"
  const title = `${city} ${type} Airport (${code}) - Parking & Drop-off`;

  // Description: "Short-term and long-term parking options at Athens Airport. Find drop-off zones, valet services, and car rental return instructions."
  const description = `Short-term and long-term parking options at ${city} ${type} Airport. Find drop-off zones, valet services, and car rental return instructions.`;
