...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Athens International Airport (ATH) Transport & Access Guide"
  const title = `${city} ${type} Airport (${code}) Transport & Access Guide`;

  // Description: "Compare taxis, buses, car rentals, and parking at Athens International Airport. Find driving directions and transfer options for a smooth journey."
  const description = `Compare taxis, buses, car rentals, and parking at ${city} ${type} Airport. Find driving directions and transfer options for a smooth journey.`;
