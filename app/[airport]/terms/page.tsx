...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Title: "Terms of Use - Athens International Airport (ATH) Guide"
  const title = `Terms of Use - ${city} ${type} Airport (${code}) Guide`;

  // Description: "Read the Terms of Use for the Athens Airport Guide. Legal disclaimer regarding information accuracy and liability limitations."
  const description = `Read the Terms of Use for the ${city} ${type} Airport Guide. Legal disclaimer regarding information accuracy and liability limitations.`;
