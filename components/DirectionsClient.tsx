    ...
    <main className="min-h-screen bg-[#F3F4FE]">
      ...
      <div className="bg-[#0C1A47] text-white pt-32 pb-24 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* SEO FIX: H1 Matches "Directions" slug context directly */}
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight leading-tight">
            Directions & <span className="text-[#FFD600]">Transport</span>{" "}
            <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-white to-gray-400">
              to {airport?.name || "Airport"}
            </span>
          </h1>

          <h2 className="text-xl md:text-2xl text-gray-300 max-w-2xl leading-relaxed font-normal">
            Find the best driving directions, bus routes, and transfer options
            for a seamless journey to and from the terminal.
          </h2>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl px-6 -mt-16 relative z-20 pb-20">
        ...
        <div className="bg-white rounded-[2.5rem] p-10 shadow-lg mb-16 border border-gray-100">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold text-[#0C1A47] mb-4">
                Choosing Your Transfer
              </h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Navigating the directions and transport options at{" "}
                {airport?.name} depends heavily on your priorities. If speed and
                comfort are paramount, especially after a long flight, private
                transfers or taxi apps are the superior choice. They eliminate
                the need to haul luggage to bus stops or negotiate with drivers
                at the rank.
              </p>
            </div>
            <div>
